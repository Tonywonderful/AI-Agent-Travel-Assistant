...
- 来源 ID：source_demo_city_culture_bureau
- 核验时间：2026-08-02
- 生效时间：2026-08-02
- 有效期至：2026-10-31
- 置信等级：高
...
- 来源 ID：source_demo_city_weather_and_parks
- 核验时间：2026-08-02
- 生效时间：2026-08-02
- 有效期至：2026-09-30
- 置信等级：中
...
- 来源 ID：source_demo_mountain_management
- 核验时间：2026-08-02
- 生效时间：2026-08-02
- 有效期至：2026-12-31
- 置信等级：高
...
- 来源 ID：source_demo_accommodation_survey
- 核验时间：2026-08-02
- 生效时间：2026-08-02
- 有效期至：2026-08-31
- 置信等级：中
...
### 目的地概览：第一次到访云岚市（content_yunlan_first_visit_overview）

- 内容 ID：content_yunlan_first_visit_overview
- 内容类型：目的地概览
- 关联地点：place_yunlan_city
- 适合人群：第一次到访者、慢节奏旅行者、亲子游客、摄影爱好者
- 推荐天数：2 至 4 天
- 主要实体：attraction_yunlan_old_town、attraction_jinghu_viewpoint、activity_nanxi_handicraft_street、activity_qinglan_summit_trail

第一次到访云岚市时，建议把低强度的古城、镜湖和南溪街区作为基础行程。想看自然景观且体力允许时，再加入青岚山。两天适合完成古城与镜湖；三天可以加入青岚山或自然博物馆；四天适合保留慢行、手作体验和天气调整空间。

### 行程：轻松拍照一日路线（itinerary_yunlan_easy_photo_day）

- 行程 ID：itinerary_yunlan_easy_photo_day
- 行程类型：一日路线
- 行程强度：低
- 适合人群：不想早起者、情侣、摄影爱好者、老人同行者
- 包含实体 ID：attraction_yunlan_old_town、food_nanxi_small_bistro、attraction_jinghu_viewpoint、food_lakeside_fish_house
- 交通原则：古城内部步行；古城到镜湖东岸使用短途网约车或公交
- 替代实体：attraction_yunlan_nature_museum

上午从云岚古城南门进入，沿望湖巷和临水街道慢走游览；午餐前往南溪小馆；下午前往镜湖东岸观景台，在日落前到达湖边；晚餐可选择湖畔鱼馆。若降雨或能见度较低，可将镜湖日落替换为云岚自然博物馆。

### 行程：亲子两日路线（itinerary_yunlan_family_two_days）

- 行程 ID：itinerary_yunlan_family_two_days
- 行程类型：两日路线
- 行程强度：低至中
- 适合人群：儿童家庭、希望减少爬坡的旅行者
- 第一天实体 ID：attraction_yunlan_nature_museum、attraction_jinghu_wetland_park、attraction_jinghu_viewpoint
- 第二天实体 ID：attraction_yunlan_old_town、activity_nanxi_handicraft_street、food_nanxi_small_bistro
- 住宿建议实体 ID：accommodation_nanxi_lane_hotel、accommodation_jinghu_yunqi_hotel
- 安排原则：上午优先室内或平缓路线；下午保留休息与天气调整时间

第一天上午参观云岚自然博物馆，午餐后在镜湖湿地公园散步，傍晚前往镜湖东岸看日落。第二天上午游览云岚古城，下午在南溪手作街参加短时体验，晚餐在南溪街区解决。该路线不安排青岚山，避免将爬坡与亲子活动叠加。

### 行程：徒步与自然三日路线（itinerary_yunlan_nature_three_days）

- 行程 ID：itinerary_yunlan_nature_three_days
- 行程类型：三日路线
- 行程强度：中
- 适合人群：有轻量徒步经验、喜欢自然景观的旅行者
- 第一天实体 ID：attraction_jinghu_wetland_park、attraction_jinghu_viewpoint
- 第二天实体 ID：activity_qinglan_summit_trail、food_bamboo_creek_restaurant
- 第三天实体 ID：attraction_yunlan_old_town、activity_nanxi_handicraft_street
- 住宿建议实体 ID：accommodation_qinglan_summit_resort、accommodation_nanxi_lane_hotel
- 安全替代实体：attraction_yunlan_nature_museum

第一天在镜湖湿地和东岸完成低强度自然体验；第二天安排青岚山徒步，并在山脚餐馆用餐；第三天回到古城和南溪街区，安排文化体验和轻松步行。徒步日不再叠加长距离城市步行；连续降雨或雷雨预警时，第二天改为自然博物馆与南溪街区。

## 8. 来源登记

### 来源记录：城市文化管理部门（source_demo_city_culture_bureau）

- 来源 ID：source_demo_city_culture_bureau
- 来源类型：目的地官方机构
- 负责范围：古城公共区域、文化场馆、活动开放安排
- 可信级别：高
- 更新方式：官方公告或场馆通知发生变化时更新

该来源用于核验云岚古城和文化场馆的开放规则。正式知识库应在非向量化来源注册表中保存原始页面地址、公告编号和内容快照。

### 来源记录：城市气象与公园管理部门（source_demo_city_weather_and_parks）

- 来源 ID：source_demo_city_weather_and_parks
- 来源类型：目的地官方机构
- 负责范围：镜湖天气条件、公园管理、湖畔风险提示
- 可信级别：高
- 更新方式：天气预警或公园管理信息变化时更新

该来源用于支持湖畔天气、能见度、风力和公园游览条件。天气属于高时效信息，生成实际行程时还应调用实时天气服务，而不是只依赖静态知识库。

### 来源记录：青岚山景区管理部门（source_demo_mountain_management）

- 来源 ID：source_demo_mountain_management
- 来源类型：景区官方机构
- 负责范围：步道开放、山地安全、临时关闭与应急提示
- 可信级别：高
- 更新方式：景区公告、气象预警或现场安全条件变化时更新

该来源用于判断青岚山云顶步道是否适合进入。安全事实过期后不得继续用于推荐，系统应优先返回需要重新核验的状态。

### 来源记录：住宿价格抽样调查（source_demo_accommodation_survey）

- 来源 ID：source_demo_accommodation_survey
- 来源类型：多来源价格抽样
- 负责范围：住宿常规价格区间和季节性波动
- 可信级别：中
- 更新方式：按月抽样，并在节假日前补充核验

该来源只支持住宿预算初筛，不代表实时成交价格。用户进入预订阶段时，应通过实时渠道确认价格、库存、取消政策和具体房型。
